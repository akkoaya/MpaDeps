...
if(PORT STREQUAL "mpa-onnxruntime")
    set(VCPKG_LIBRARY_LINKAGE dynamic)
  endif()

if(PORT STREQUAL "mpa-fastdeploy")
  set(VCPKG_LIBRARY_LINKAGE dynamic)
endif()

set(VCPKG_CMAKE_CONFIGURE_OPTIONS ${VCPKG_CMAKE_CONFIGURE_OPTIONS} -DCMAKE_SHARED_LIBRARY_SUFFIX_CXX=_mpa.dll)
